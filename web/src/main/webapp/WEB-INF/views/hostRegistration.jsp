...
<div class="generic-container">
    ...
    <form:form method="POST" modelAttribute="host" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="hostDetail">Unit Detail</label>
                <div class="col-md-7">
