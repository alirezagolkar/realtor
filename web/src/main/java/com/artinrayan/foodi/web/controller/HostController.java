...
//	@Qualifier(value = "categoryServiceTransactionalImpl")
	...
	public String updateHost(@Valid Host host, BindingResult result,
		...
		model.addAttribute("success", "Unit " + host.getHostName() + " updated successfully");
		return ViewUtil.Views.HOSTSUCCESS.getViewName();
	}
	...
	public String saveAttachment(@Valid Attachment newAttachment, BindingResult result,
...
//		}
     ...
     */
	@RequestMapping(value = { "/unitDetail-{hostId}" }, method = RequestMethod.GET)
